...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/85 backdrop-blur-2xl transition-all shadow-2xl h-20 flex items-center">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        
        {/* LEFT ACTION (Hidden on Booking Page) */}
        {!isBookingPage ? (
        ...
        <div className="flex-1 flex justify-center">
          <Link
            ...
            className="group relative flex items-center gap-3.5 px-5 py-2 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-teal-500/50 hover:bg-slate-900/90 transition-all duration-300 shadow-xl shadow-black/40 hover:scale-105 active:scale-95 cursor-pointer"
          >
        ...
        {/* RIGHT ACTION (Hidden on Booking Page) */}
        {!isBookingPage ? (
